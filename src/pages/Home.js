      ...
      <div className='row'>
        ...
        <div className='col-6'>
          ...
          <div className='small-banner position-relative'>
            <img src="images/catbanner-01.jpg" className='img-fluid rounder-3' alt='main banner' />
          ...
          <div className='small-banner position-relative'>
            <img src="images/catbanner-02.jpg" className='img-fluid rounder-3' alt='main banner' />
            <div className='small-banner-content position-absolute'>
              <h4>NEW ARRIVAL</h4>
              <h5>Buy IPad Air</h5>
              <p>From $999.00 <br/>or $41.62/mo.</p>
          ...
          <div className='small-banner position-relative'>
            <img src="images/catbanner-03.jpg" className='img-fluid rounder-3' alt='main banner' />
            <div className='small-banner-content position-absolute'>
              <h4>15% OFF</h4>
              <h5>Smartwatch 7</h5>
              <p>From $999.00 <br/>or $41.62/mo.</p>
          ...
          <div className='small-banner position-relative'>
            <img src="images/catbanner-04.jpg" className='img-fluid rounder-3' alt='main banner' />
            <div className='small-banner-content position-absolute'>
