      ...
      <div className='row'>
        <div className='col-3'>
          ...
          <div className='filter-card mb-3'>
            ...
            <div>
              <h5 className='sub-title'>Avilablity</h5>
              <div>
                <div className='form-check'>
                <input className='form-check-input' type="checkbox" value="" id='' />
                <label className='form-check-label' htmlhtmlfor="" >
                  In Stock (1)
                </label>
              </div>
              <div className='form-check'>
...
<div className="form-floating">
  ...
  <label htmlfor="floatingInput1">To</label>
              ...
              <div className='form-check'>
                ...
                <label className='form-check-label' htmlhtmlfor="color-1" >
                  S (2)
                </label>
              </div>
              <div className='form-check'>
                <input className='form-check-input' type="checkbox" value="" id='color-2' />
                <label className='form-check-label' htmlhtmlfor="color-2" >
                  M (2)
                </label>
              </div>
              </div>
