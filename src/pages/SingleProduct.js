                ...
                <div className='border-bottom py-3'>
                  ...
                  <div className='d-flex gap-10 flex-column mt-2 mb-3'>
                    ...
                    <div className='d-flex flex-wrap gap-15'>
                      ...
                      <span className='badge border border-1 bg-white text-dark border-secondary'>H</span>
                ...
                <div className='reviews mt-4'>
                  <div className='review'>
                    <div className='d-flex gap-10 align-items-center'>
                      <h6 className='mb-0'>Doulath</h6>
                      <ReactStars count={5} size={24} value={4}  edit={false} activeColor="#ffd700" />

                    </div>
                  <p className='mt-3'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Consectetur fugit ut excepturi quos. Id reprehenderit voluptatem placeat consequatur suscipit ex. Accusamus dolore quisquam deserunt voluptate, sit magni perspiciatis quas iste?</p>
