  ...
  <footer className='py-4' >
    <div className='container-xxl'>
      <div className='row align-items-center'>
        <div className='col-5'>
          <div className='footer-top-data d-flex fap-30 align-items-center'>
      ...
      <div className='row'>
        <div className='col-4'>
          ...
          <div>
            ...
            <a href='tel:+91 9154598528' className='mt-3 d-block mb-1 text-white'>+91 9154598528</a>
            <a href='mailto:nayabsyeddoulathbasha@gmail.com' className='mt-2 d-block mb-0 text-white'>nayabsyeddoulathbasha@gmail.com</a>
        ...
        <div className='col-2'>
          ...
          <div className='footer-links d-flex flex-column'>
            ...
            <Link className='text-white py-2 mb-1'>Loptops</Link>
    ...
    <div className='container-xxl'>
      <div className='row'>
        <div className='col-12'>
          <p className='text-center mb-0 text-white'>© {new Date().getFullYear()}: Powered by Developer's Corner</p>
        </div>
      </div>
    </div>
  </footer>
